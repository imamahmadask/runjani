    ...
    <div id="wrapper">
                ...
                <div class="row clearfix">
                    <div class="col-1">
                        ...
                        <div id="logo">
                            ...
                            <img src="{{ asset('frontend/images/logo-2.png') }}" id="navigation-logo"
                                alt="Landing Page" />
        ...
        <main id="content">
            ...
            <aside id="gallery" class="row text-center scrollto clearfix" data-featherlight-gallery
                ...
                <a href="images/gallery-images/gallery-image-1.jpg" data-featherlight="image"
                    class="col-3 wow fadeIn" data-wow-delay="0.1s"><img
                        src="{{ asset('frontend/images/gallery-images/gallery-image-1.jpg') }}"
                        alt="Landing Page" /></a>
                <a href="images/gallery-images/gallery-image-2.jpg" data-featherlight="image"
                    class="col-3 wow fadeIn" data-wow-delay="0.3s"><img
                        src="{{ asset('frontend/images/gallery-images/gallery-image-2.jpg') }}"
                        alt="Landing Page" /></a>
                <a href="images/gallery-images/gallery-image-3.jpg" data-featherlight="image"
                    class="col-3 wow fadeIn" data-wow-delay="0.5s"><img
                        src="{{ asset('frontend/images/gallery-images/gallery-image-3.jpg') }}"
                        alt="Landing Page" /></a>
                <a href="images/gallery-images/gallery-image-4.jpg" data-featherlight="image"
                    class="col-3 wow fadeIn" data-wow-delay="1.1s"><img
                        src="{{ asset('frontend/images/gallery-images/gallery-image-4.jpg') }}"
                        alt="Landing Page" /></a>
                <a href="images/gallery-images/gallery-image-5.jpg" data-featherlight="image"
                    class="col-3 wow fadeIn" data-wow-delay="0.9s"><img
                        src="{{ asset('frontend/images/gallery-images/gallery-image-5.jpg') }}"
                        alt="Landing Page" /></a>
                <a href="images/gallery-images/gallery-image-6.jpg" data-featherlight="image"
                    class="col-3 wow fadeIn" data-wow-delay="0.7s"><img
                        src="{{ asset('frontend/images/gallery-images/gallery-image-6.jpg') }}"
                        alt="Landing Page" /></a>
            ...
            <section id="clients" class="scrollto clearfix">
                <div class="row clearfix">
                    ...
                    <div class="col-2-3">
                        ...
                        <a href="#" class="col-3">
                            <img src="{{ asset('frontend/images/company-images/company-logo1.png') }}"
                                alt="Company" />
                            <div class="client-overlay"><span>Tree</span></div>
                        </a>
                        <a href="#" class="col-3">
                            <img src="{{ asset('frontend/images/company-images/company-logo2.png') }}"
                                alt="Company" />
                            <div class="client-overlay"><span>Fingerprint</span></div>
                        </a>
                        <a href="#" class="col-3">
                            <img src="{{ asset('frontend/images/company-images/company-logo3.png') }}"
                                alt="Company" />
                            <div class="client-overlay"><span>The Man</span></div>
                        </a>
                        <a href="#" class="col-3">
                            <img src="{{ asset('frontend/images/company-images/company-logo4.png') }}"
                                alt="Company" />
                            <div class="client-overlay"><span>Mustache</span></div>
                        </a>
                        <a href="#" class="col-3">
                            <img src="{{ asset('frontend/images/company-images/company-logo5.png') }}"
                                alt="Company" />
                            <div class="client-overlay"><span>Goat</span></div>
                        </a>
                        <a href="#" class="col-3">
                            <img src="{{ asset('frontend/images/company-images/company-logo6.png') }}"
                                alt="Company" />
                            <div class="client-overlay"><span>Justice</span></div>
                        </a>
                        <a href="#" class="col-3">
                            <img src="{{ asset('frontend/images/company-images/company-logo7.png') }}"
                                alt="Company" />
                            <div class="client-overlay"><span>Ball</span></div>
                        </a>
                        <a href="#" class="col-3">
                            <img src="{{ asset('frontend/images/company-images/company-logo8.png') }}"
                                alt="Company" />
                            <div class="client-overlay"><span>Cold</span></div>
                        </a>

                        <a href="#" class="col-3">
                            <img src="{{ asset('frontend/images/company-images/company-logo9.png') }}"
                                alt="Company" />
                            <div class="client-overlay"><span>Cold</span></div>
                        </a>
