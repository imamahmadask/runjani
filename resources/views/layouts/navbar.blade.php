    ...
    <div class="row clearfix">
        <div class="col-1">
            ...
            <div id="logo">
                ...
                <img src="{{ asset('frontend/images/logo-runjani-2.png') }}" id="banner-logo" alt="Landing Page" />
                <!--End of Banner Logo-->

                <!--The Logo that is shown on the sticky Navigation Bar-->
                <img src="{{ asset('frontend/images/logo-runjani-2.png') }}" id="navigation-logo" alt="Landing Page" />
